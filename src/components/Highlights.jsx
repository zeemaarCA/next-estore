...
export default function Highlights() {
  return (
    <div className="flex flex-col md:flex-row gap-5 md:gap-0 justify-between items-start md:items-center mt-10 bg-primary/10 py-8 px-4 rounded-lg border border-primary/20">
      <div className="highlight-item flex justify-between items-start gap-2">
